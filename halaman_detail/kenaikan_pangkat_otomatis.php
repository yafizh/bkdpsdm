<?php
if (isset($_GET['id'])) {
    $result = $mysqli->query("SELECT kenaikan_pangkat_otomatis.*, pegawai.nip, pegawai.nama FROM kenaikan_pangkat_otomatis INNER JOIN pegawai ON pegawai.id=kenaikan_pangkat_otomatis.id_pegawai WHERE kenaikan_pangkat_otomatis.id=" . $_GET['id']);
    ...
    $dokumen8 = $data['sk_kenaikan_pangkat'];
} else {
...
if ($_SESSION['status'] === 'ADMIN') {
    if (isset($_POST['selesai'])) {
        ...
        $dokumen8 = $target_dir . Date("YmdHis") . "8." . strtolower(pathinfo(basename($_FILES["sk_kenaikan_pangkat"]["name"]), PATHINFO_EXTENSION));
        move_uploaded_file($_FILES["sk_kenaikan_pangkat"]["tmp_name"], $dokumen8);
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Pengajuan Kenaikan Pangkat Otomatis</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Pengajuan Kenaikan Pangkat Otomatis</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <?php if ($data['status'] == "PENGAJUAN" || $data['status'] == "DITOLAK") : ?>
                                <a href="?page=otomatis&method=edit&id=<?= $data['id'] ?>" class="btn btn-warning ml-2 mr-2">Edit</a>
                                <form action="?page=otomatis&method=hapus&id=<?= $data['id'] ?>" method="POST" class="d-inline">
            ...
            <div class="col-md-6">
                ...
                <?php if ($_SESSION['status'] === 'PEGAWAI' && $data['status'] === "SELESAI") : ?>
                    <div class="card card-success collapsed-card">
                        ...
                        <div class="card-body" style="height: 640px; display: none;">
                            <iframe src="<?= $dokumen8; ?>" id="preview-sk_kenaikan_pangkat" style="width: 100%; height: 100%;" frameborder="0"></iframe>
                        </div>
                    </div>
                <?php endif; ?>

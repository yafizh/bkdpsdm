...
if (isset($_GET['id'])) {
    ...
    $dokumen8 = $data['ktp'];
    $dokumen9 = $data['sk_kenaikan_pangkat'];
} else {
...
if ($_SESSION['status'] === 'ADMIN') {
    if (isset($_POST['selesai'])) {
        ...
        $dokumen9 = $target_dir . Date("YmdHis") . "9." . strtolower(pathinfo(basename($_FILES["sk_kenaikan_pangkat"]["name"]), PATHINFO_EXTENSION));
        move_uploaded_file($_FILES["sk_kenaikan_pangkat"]["tmp_name"], $dokumen9);
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="col-md-6">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="card card-primary">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a href="?page=fungsional" class="btn btn-secondary mr-2">Kembali</a>
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary collapsed-card">
                    <div class="card-header">
                        <h3 class="card-title">Dokumen SK Pengangkatan Jabatan Fungsional</h3>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                <i class="fas fa-plus"></i>
                            </button>
                ...
                <?php if ($_SESSION['status'] === 'PEGAWAI' && $data['status'] === "SELESAI") : ?>
                    <div class="card card-success collapsed-card">
                        ...
                        <div class="card-body" style="height: 640px; display: none;">
                            <iframe src="<?= $dokumen9; ?>" id="preview-sk_kenaikan_pangkat" style="width: 100%; height: 100%;" frameborder="0"></iframe>
                        </div>
                    </div>
                <?php endif; ?>
